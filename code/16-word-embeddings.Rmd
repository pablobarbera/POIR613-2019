...
We'll start by computing the most similar words to a specific word, where _similar_ means how close they are on the latent multidimensional space (cosine similarity).
...
As an alternative way to think of embeddings, see this cool [online visualization](https://github.com/anvaka/word2vec-graph).
