...
searchTweets(q=c("impeachment", "trump"), 
  filename="data/recent-impeachment-tweets.json",
  n=1000, until="2019-11-09", 
  oauth=my_oauth)

tweets <- parseTweets("data/recent-impeachment-tweets.json")
```
...
A large proportion of Twitter accounts may be automated (bots). The Botometer API offers a way to check for sign of automation. The code below, adapted from the package by `@marsha5814` shows one way to interact with that API.
...
results <- botometer("uscpoir", my_oauth, 
